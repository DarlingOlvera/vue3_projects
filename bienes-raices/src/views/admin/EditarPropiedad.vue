...
<template>
 <v-card max-width="800" flat class="mx-auto my-10">
    <v-card-title class="mt-5">
        <h1 class="text-h4 font-weight-bold text-center">Editar Propiedad</h1>
    </v-card-title>
    <v-card-subtitle > 
        <p class="text-h5 text-center">Edita los detalles de la propiedad</p>
    </v-card-subtitle>
    ...
    <v-form class="mt-10">
        ...
        <h2 class="font-weight-bold mb-2">Ubicación</h2>
        <div class="pb-10">
